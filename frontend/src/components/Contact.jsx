...
export default function Contact() {
  ...
  return (
    <>
    <div className="isolate bg-[#212121] px-6 py-24 sm:py-32 lg:px-8">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-2xl -mt-8 text-center">
        <h2 className="text-4xl font-bold tracking-tight text-balance text-white sm:text-5xl">Contact Us! </h2>
        <p className="mt-2 text-lg/8 text-white font-bold"> Let's Communicate, Let's Customise</p>
      </div>
              ...
              <div className="flex rounded-md bg-white outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-indigo-600">
                <div className="grid shrink-0 grid-cols-1 focus-within:relative">
                  <select
                    ...
                    aria-label="Country"
                    className="col-start-1 row-start-1 w-full rounded-md py-2 pr-7 pl-3.5 text-base text-black placeholder:text-white focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                  >
                    <option>US</option>
                    <option>CA</option>
                    <option>EU</option>
      ...
      <div className='h-full w-full bg-[#212121] flex justify-center border-2 border-[#212121] rounded-lg p-1'>
    <button
      type="submit"
      className="w-fit h-full rounded-md bg-yellow-200 p-3 text-center text-sm font-bold text-[#212121] shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
    >
      Let's talk
    </button>
  </div>
